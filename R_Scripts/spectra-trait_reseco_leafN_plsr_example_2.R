...
Jackknife_intercept <- plsr_permutation$coef_array[1,,nComps]
hist(Jackknife_intercept)
Jackknife_coef <- plsr_permutation$coef_array[2:length(plsr_permutation$coef_array[,1,nComps]),,nComps]
