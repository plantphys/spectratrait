---
title: Spectra-trait PLSR example using NEON AOP pixel spectra and field-sampled leaf mass area (LMA) from CONUS NEON sites
...
vignette: >
  %\VignetteIndexEntry{Spectra-trait PLSR example using NEON AOP pixel spectra and field-sampled leaf mass area (LMA) from CONUS NEON sites}
...
pixel-scale spectra-trait PLSR models. This example uses image data from NEON AOP and associated field measurements of leaf mass area (LMA) collected across a range of CONUS NEON sites.  For more information refer to the dataset EcoSIS page:
